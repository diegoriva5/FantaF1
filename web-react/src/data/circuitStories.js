...
// Albert Park
const TECHNICAL_DATA_ALBERT_PARK = `Città: Melbourne\nLunghezza: 5.278 km\nCurve: 14\nPrimo GP di Formula 1: 1996\nGiri di gara: 58\nRecord pista: 1:19.813 (2024, Charles Leclerc)`;

// Monaco
const TECHNICAL_DATA_MONACO = `Città: Monte Carlo\nLunghezza: 3.337 km\nCurve: 19\nPrimo GP di Formula 1: 1950\nGiri di gara: 78\nRecord pista: 1:12.909 (2021, Hamilton)`;

// Silverstone
const TECHNICAL_DATA_SILVERSTONE = `Città: Silverstone\nLunghezza: 5.891 km\nCurve: 18\nPrimo GP di Formula 1: 1950\nGiri di gara: 52\nRecord pista: 1:27.097 (2020, Verstappen)`;

// Spa-Francorchamps
const TECHNICAL_DATA_SPA = `Città: Stavelot\nLunghezza: 7.004 km\nCurve: 19\nPrimo GP di Formula 1: 1950\nGiri di gara: 44\nRecord pista: 1:46.286 (2018, Bottas)`;

// Suzuka
const TECHNICAL_DATA_SUZUKA = `Città: Suzuka\nLunghezza: 5.807 km\nCurve: 18\nPrimo GP di Formula 1: 1987\nGiri di gara: 53\nRecord pista: 1:30.983 (2019, Hamilton)`;

// Monza
const TECHNICAL_DATA_MONZA = `Città: Monza\nLunghezza: 5.793 km\nCurve: 11\nPrimo GP di Formula 1: 1950\nGiri di gara: 53\nRecord pista: 1:21.046 (2020, Hamilton)`;

// Shanghai
const TECHNICAL_DATA_SHANGHAI = `Città: Shanghai\nLunghezza: 5.451 km\nCurve: 16\nPrimo GP di Formula 1: 2004\nGiri di gara: 56\nRecord pista: 1:32.238 (2004, Schumacher)`;

// Bahrain
const TECHNICAL_DATA_BAHRAIN = `Città: Sakhir\nLunghezza: 5.412 km\nCurve: 15\nPrimo GP di Formula 1: 2004\nGiri di gara: 57\nRecord pista: 1:31.447 (2020, Verstappen)`;

// Jeddah
const TECHNICAL_DATA_JEDDAH = `Città: Jeddah\nLunghezza: 6.174 km\nCurve: 27\nPrimo GP di Formula 1: 2021\nGiri di gara: 50\nRecord pista: 1:30.734 (2021, Hamilton)`;

// Miami
const TECHNICAL_DATA_MIAMI = `Città: Miami\nLunghezza: 5.412 km\nCurve: 19\nPrimo GP di Formula 1: 2022\nGiri di gara: 57\nRecord pista: 1:29.708 (2022, Hamilton)`;

// Montreal
const TECHNICAL_DATA_MONTREAL = `Città: Montreal\nLunghezza: 4.361 km\nCurve: 14\nPrimo GP di Formula 1: 1978\nGiri di gara: 70\nRecord pista: 1:13.078 (2019, Bottas)`;

// Catalunya
const TECHNICAL_DATA_CATALUNYA = `Città: Barcellona\nLunghezza: 4.657 km\nCurve: 14\nPrimo GP di Formula 1: 1991\nGiri di gara: 66\nRecord pista: 1:18.149 (2021, Verstappen)`;

// Red Bull Ring
const TECHNICAL_DATA_REDBULLRING = `Città: Spielberg\nLunghezza: 4.318 km\nCurve: 10\nPrimo GP di Formula 1: 1970\nGiri di gara: 71\nRecord pista: 1:05.619 (2020, Sainz)`;

// Hungaroring
const TECHNICAL_DATA_HUNGARORING = `Città: Budapest\nLunghezza: 4.381 km\nCurve: 14\nPrimo GP di Formula 1: 1986\nGiri di gara: 70\nRecord pista: 1:16.627 (2020, Hamilton)`;

// Zandvoort
const TECHNICAL_DATA_ZANDVOORT = `Città: Zandvoort\nLunghezza: 4.259 km\nCurve: 14\nPrimo GP di Formula 1: 1952\nGiri di gara: 72\nRecord pista: 1:11.097 (2021, Hamilton)`;

// Madrid (dati ipotetici, circuito nuovo)
const TECHNICAL_DATA_MADRID = `Città: Madrid\nLunghezza: 5.474 km\nCurve: 20\nPrimo GP di Formula 1: 2026\nGiri di gara: 70\nRecord pista: -`;

// Baku
const TECHNICAL_DATA_BAKU = `Città: Baku\nLunghezza: 6.003 km\nCurve: 20\nPrimo GP di Formula 1: 2016\nGiri di gara: 51\nRecord pista: 1:43.009 (2019, Leclerc)`;

// Singapore
const TECHNICAL_DATA_SINGAPORE = `Città: Singapore\nLunghezza: 4.940 km\nCurve: 19\nPrimo GP di Formula 1: 2008\nGiri di gara: 62\nRecord pista: 1:35.867 (2023, Hamilton)`;

// Austin
const TECHNICAL_DATA_AUSTIN = `Città: Austin\nLunghezza: 5.513 km\nCurve: 20\nPrimo GP di Formula 1: 2012\nGiri di gara: 56\nRecord pista: 1:36.169 (2019, Leclerc)`;

// Messico
const TECHNICAL_DATA_MEXICO = `Città: Città del Messico\nLunghezza: 4.304 km\nCurve: 17\nPrimo GP di Formula 1: 1963\nGiri di gara: 71\nRecord pista: 1:17.774 (2019, Bottas)`;

// Interlagos
const TECHNICAL_DATA_INTERLAGOS = `Città: San Paolo\nLunghezza: 4.309 km\nCurve: 15\nPrimo GP di Formula 1: 1973\nGiri di gara: 71\nRecord pista: 1:10.540 (2018, Bottas)`;

// Las Vegas
const TECHNICAL_DATA_LASVEGAS = `Città: Las Vegas\nLunghezza: 6.201 km\nCurve: 17\nPrimo GP di Formula 1: 2023\nGiri di gara: 50\nRecord pista: 1:35.490 (2023, Hamilton)`;

// Lusail
const TECHNICAL_DATA_LUSAIL = `Città: Lusail\nLunghezza: 5.419 km\nCurve: 16\nPrimo GP di Formula 1: 2021\nGiri di gara: 57\nRecord pista: 1:24.319 (2023, Verstappen)`;

// Yas Marina
const TECHNICAL_DATA_YASMARINA = `Città: Abu Dhabi\nLunghezza: 5.281 km\nCurve: 16\nPrimo GP di Formula 1: 2009\nGiri di gara: 58\nRecord pista: 1:26.103 (2021, Verstappen)`;

// Marina Bay
const TECHNICAL_DATA_MARINABAY = `Città: Singapore\nLunghezza: \nCurve: \nPrimo GP di Formula 1: \nGiri di gara: \nRecord pista: `;
...
const CIRCUIT_STORIES = {
    albert_park: {
        it: {
          ...
          technicalData: TECHNICAL_DATA_ALBERT_PARK,
    ...
    shanghai: {
        it: {
          ...
          technicalData: TECHNICAL_DATA_SHANGHAI,
    ...
    suzuka: {
      it: {
        headline: "Tecnica e ritmo a otto",
          technicalData: TECHNICAL_DATA_SUZUKA,
    ...
    bahrain: {
      it: {
        headline: "Accelerazioni e sorpassi nel deserto",
          technicalData: TECHNICAL_DATA_BAHRAIN,
    ...
    jeddah: {
      it: {
        headline: "Velocità urbana sul Mar Rosso",
          technicalData: TECHNICAL_DATA_JEDDAH,
    ...
    miami: {
      it: {
        headline: "Modernità e velocità intorno allo stadio",
          technicalData: TECHNICAL_DATA_MIAMI,
    ...
    montreal: {
      it: {
        headline: "Imprevedibilità sull'isola di Notre-Dame",
          technicalData: TECHNICAL_DATA_MONTREAL,
    ...
    monaco: {
      it: {
        headline: "Icona e precisione assoluta",
          technicalData: TECHNICAL_DATA_MONACO,
      ...
      es: {
        headline: "Pure precisión entre barreras",
        technicalData: TECHNICAL_DATA_MONACO,
        presentation: "Mónaco es el símbolo de la Fórmula 1: estrecho, sinuoso y con casi ningún margen de error. Las barreras están siempre cerca y la clasificación suele ser más importante que la carrera.",
        trackFeatures: "Circuito urbano con curvas lentas, cambios rápidos de dirección y asfalto bacheado. La pista es famosa por su dificultad y falta de áreas de escape.",
        overtakingSpots: "Los adelantamientos son casi imposibles: el único punto real es la zona de frenado de Sainte Dévote, pero requiere gran valentía y precisión.",
        iconicCorners: "Casino Square, la curva del Fairmont (la más lenta de F1), la chicane del Puerto y la Piscina son algunas de las más famosas.",
        historicalMoments: "1982 – Carrera caótica con múltiples líderes en la última vuelta. 1996 – Panis gana con solo 3 coches en meta. 2018 – Ricciardo gana a pesar de problemas técnicos.",
        curiosities: "El GP de Mónaco se celebra desde 1929. Los residentes pueden ver la carrera desde sus balcones. El circuito se monta cada año en unas 6 semanas."
      },
      fr: {
        headline: "Précision pure entre les barrières",
        technicalData: TECHNICAL_DATA_MONACO,
        presentation: "Monaco est le symbole de la Formule 1 : étroit, sinueux et avec presque aucune marge d'erreur. Les barrières sont toujours proches et la qualification est souvent plus importante que la course.",
        trackFeatures: "Circuit urbain avec des virages lents, des changements rapides de direction et un asphalte bosselé. La piste est célèbre pour sa difficulté et son manque de zones de dégagement.",
        overtakingSpots: "Les dépassements sont presque impossibles : le seul vrai point est la zone de freinage de Sainte Dévote, mais cela nécessite beaucoup de courage et de précision.",
        iconicCorners: "Casino Square, le virage du Fairmont (le plus lent de F1), la chicane du Port et la Piscine sont parmi les plus célèbres.",
        historicalMoments: "1982 – Course chaotique avec plusieurs leaders au dernier tour. 1996 – Panis gagne avec seulement 3 voitures à l'arrivée. 2018 – Ricciardo gagne malgré des problèmes techniques.",
        curiosities: "Le GP de Monaco se tient depuis 1929. Les résidents peuvent regarder la course depuis leurs balcons. Le circuit est installé chaque année en environ 6 semaines."
      },
      de: {
        headline: "Pure Präzision zwischen den Barrieren",
        technicalData: TECHNICAL_DATA_MONACO,
        presentation: "Monaco ist das Symbol der Formel 1: eng, kurvenreich und mit fast keinem Fehlerraum. Die Barrieren sind immer nah und die Qualifikation ist oft wichtiger als das Rennen.",
        trackFeatures: "Strecke mit langsamen Kurven, schnellen Richtungswechseln und holprigem Asphalt. Die Strecke ist berühmt für ihre Schwierigkeit und das Fehlen von Auslaufzonen.",
        overtakingSpots: "Überholen ist fast unmöglich: der einzige echte Punkt ist die Sainte Dévote Bremszone, aber das erfordert großen Mut und Präzision.",
        iconicCorners: "Casino Square, die Fairmont-Haarnadel (die langsamste in F1), die Hafen-Schikane und die Schwimmbad-Kurve gehören zu den berühmtesten.",
        historicalMoments: "1982 – chaotisches Rennen mit mehreren Führenden in der letzten Runde. 1996 – Panis gewinnt mit nur 3 Autos im Ziel. 2018 – Ricciardo gewinnt trotz technischer Probleme.",
        curiosities: "Der GP von Monaco findet seit 1929 statt. Anwohner können das Rennen von ihren Balkonen aus sehen. Die Strecke wird jedes Jahr in etwa 6 Wochen aufgebaut."
      },
    },
    catalunya: {
      it: {
      ...
      en: {
        ...
        technicalData: TECHNICAL_DATA_CATALUNYA,
    ...
    redbullring: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_REDBULLRING,
    ...
    silverstone: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_SILVERSTONE,
    ...
    spa: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_SPA,
    ...
    hungaroring: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_HUNGARORING,
    ...
    zandvoort: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_ZANDVOORT,
    ...
    monza: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_MONZA,
    ...
    madrid: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_MADRID,
    ...
    baku: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_BAKU,
    ...
    marinabay: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_MARINABAY,
    ...
    singapore: {
      it: {
        headline: "Notte e fatica nel centro di Singapore",
        technicalData: TECHNICAL_DATA_SINGAPORE,
        presentation: "Il Gran Premio di Singapore si corre di notte nel centro della città. È uno dei circuiti più impegnativi dal punto di vista fisico.",
        trackFeatures: "La pista è lenta e tecnica con molte curve consecutive e temperature elevate.",
        overtakingSpots: "Curva 7 – staccata dopo il rettilineo più lungo.\nCurva 14 – frenata nel centro cittadino.",
        iconicCorners: "Anderson Bridge – tratto sotto il famoso ponte storico.",
    ...
    usa: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_AUSTIN,
    ...
    mexico: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_MEXICO,
    ...
    interlagos: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_INTERLAGOS,
    ...
    lasvegas: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_LASVEGAS,
    ...
    lusail: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_LUSAIL,
    ...
    yasmarina: {
      it: {
        ...
        technicalData: TECHNICAL_DATA_YASMARINA,
...
export function getCircuitStory(circuitRef, language, circuitName) {
  // Restituisce tutti i dati della lingua corretta, più technicalData sempre aggiornato
  const fallbackName = circuitName || "Questo circuito";
  let technicalData = '';
  switch (circuitRef) {
    case 'albert_park': technicalData = TECHNICAL_DATA_ALBERT_PARK; break;
    case 'monaco': technicalData = TECHNICAL_DATA_MONACO; break;
    case 'silverstone': technicalData = TECHNICAL_DATA_SILVERSTONE; break;
    case 'spa': technicalData = TECHNICAL_DATA_SPA; break;
    case 'suzuka': technicalData = TECHNICAL_DATA_SUZUKA; break;
    case 'monza': technicalData = TECHNICAL_DATA_MONZA; break;
    case 'shanghai': technicalData = TECHNICAL_DATA_SHANGHAI; break;
    case 'bahrain': technicalData = TECHNICAL_DATA_BAHRAIN; break;
    case 'jeddah': technicalData = TECHNICAL_DATA_JEDDAH; break;
    case 'miami': technicalData = TECHNICAL_DATA_MIAMI; break;
    case 'montreal': technicalData = TECHNICAL_DATA_MONTREAL; break;
    case 'catalunya': technicalData = TECHNICAL_DATA_CATALUNYA; break;
    case 'redbullring': technicalData = TECHNICAL_DATA_REDBULLRING; break;
    case 'hungaroring': technicalData = TECHNICAL_DATA_HUNGARORING; break;
    case 'zandvoort': technicalData = TECHNICAL_DATA_ZANDVOORT; break;
    case 'madrid': technicalData = TECHNICAL_DATA_MADRID; break;
    case 'baku': technicalData = TECHNICAL_DATA_BAKU; break;
    case 'singapore': technicalData = TECHNICAL_DATA_SINGAPORE; break;
    case 'austin': technicalData = TECHNICAL_DATA_AUSTIN; break;
    case 'mexico': technicalData = TECHNICAL_DATA_MEXICO; break;
    case 'interlagos': technicalData = TECHNICAL_DATA_INTERLAGOS; break;
    case 'lasvegas': technicalData = TECHNICAL_DATA_LASVEGAS; break;
    case 'lusail': technicalData = TECHNICAL_DATA_LUSAIL; break;
    case 'yasmarina': technicalData = TECHNICAL_DATA_YASMARINA; break;
    case 'marinabay': technicalData = TECHNICAL_DATA_MARINABAY; break;
    default: technicalData = ''; break;
  }
  // Recupera i dati della lingua corretta
  const stories = CIRCUIT_STORIES[circuitRef];
  const lang = (typeof language === 'string' ? language : 'it').toLowerCase();
  let storyLang = stories && stories[lang];
  // Fallback su italiano o inglese se la lingua non esiste
  if (!storyLang) storyLang = (stories && (stories['it'] || stories['en'])) || {};
  if (!technicalData) {
    const fallback = language === "en" ? fallbackStoryEn(fallbackName) : fallbackStoryIt(fallbackName);
