...
export const HISTORIC_ERAS = [
  ...
  },
  {
    ...
    drivers: [
      { name: "Jackie Stewart", nationality: "UK 🇬🇧", titles: 3, image: "placeholder" },
      { name: "Niki Lauda", nationality: "Austria 🇦🇹", titles: 3, image: "placeholder" },
      { name: "Emerson Fittipaldi", nationality: "Brazil 🇧🇷", titles: 2, image: "placeholder" },
      { name: "James Hunt", nationality: "UK 🇬🇧", titles: 1, image: "placeholder" }
    ],
  ...
  },
  {
    ...
    drivers: [
      { name: "Ayrton Senna", nationality: "Brazil 🇧🇷", titles: 3, image: "placeholder" },
      { name: "Alain Prost", nationality: "France 🇫🇷", titles: 4, image: "placeholder" },
      { name: "Nelson Piquet", nationality: "Brazil 🇧🇷", titles: 3, image: "placeholder" },
      { name: "Nigel Mansell", nationality: "UK 🇬🇧", titles: 1, image: "placeholder" }
    ],
  ...
  },
  {
    ...
    drivers: [
      { name: "Michael Schumacher", nationality: "Germany 🇩🇪", titles: 7, image: "placeholder" },
      { name: "Mika Häkkinen", nationality: "Finland 🇫🇮", titles: 2, image: "placeholder" },
      { name: "Fernando Alonso", nationality: "Spain 🇪🇸", titles: 2, image: "placeholder" },
      { name: "Sebastian Vettel", nationality: "Germany 🇩🇪", titles: 4, image: "placeholder" }
    ],
  ...
  },
  {
    ...
    drivers: [
      { name: "Lewis Hamilton", nationality: "UK 🇬🇧", titles: 7, image: "placeholder" },
      { name: "Nico Rosberg", nationality: "Germany 🇩🇪", titles: 1, image: "placeholder" },
      { name: "Max Verstappen", nationality: "Netherlands 🇳🇱", titles: 3, image: "placeholder" },
      { name: "Charles Leclerc", nationality: "Monaco 🇲🇨", titles: 0, image: "placeholder" },
      { name: "Lando Norris", nationality: "UK 🇬🇧", titles: 0, image: "placeholder" }
    ],
